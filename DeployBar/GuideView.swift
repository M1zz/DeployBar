    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 18) {
                ...
                Section(title: "2. 카드에 뜨는 색이 뜻하는 것", icon: "circle.fill") {
                ...
                Section(title: "3. 배포가 막히는 이유와 해결", icon: "exclamationmark.triangle.fill") {
                ...
                Section(title: "4. 새 앱을 배포 대상으로 만들기", icon: "wand.and.stars") {
                    Steps([
                ...
                Section(title: "5. deploy.env — 앱의 배포 규칙 전부", icon: "doc.text") {
                ...
                Section(title: "6. 릴리즈노트", icon: "doc.richtext") {
                    Text("""
                ...
                Section(title: "7. 처음 한 번 해 둘 것", icon: "gearshape") {
