        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 18) {
                ...
                Section(title: "5. '배포 준비 7/10' 이 뜻하는 것", icon: "checklist") {
                    ...
                    Note("스크린샷을 찍은 뒤로 화면 파일이 바뀌면 ⚠️ [스크린샷이 화면 변화보다 오래됐습니다] 가 뜨고, 그 줄의 [프롬프트 복사] 가 다시 찍을 지시문을 넣어 줍니다. 배포를 막지는 않습니다.")
                    Note("⋯ 메뉴의 [앱스토어 그림 프롬프트] 는 스크린샷·미리보기 영상 쪽 지시문입니다. 지금 걸린 그림이 언제 찍혔고 그 뒤로 어느 화면이 바뀌었는지까지 적어 주므로, 무엇을 다시 찍어야 하는지 세지 않아도 됩니다. 찍는 건 붙여넣은 세션이, 스토어에 올리는 건 사람이 웹에서 합니다.")
                }
